...
class Record(Base):
    ...
    activity: Mapped["Activity"] = relationship(backref="records")
...
class Lap(Base):
    ...
    activity: Mapped["Activity"] = relationship(backref="laps")
...
class Session(Base):
    ...
    activity: Mapped["Activity"] = relationship(backref="sessions")
